...
class Game:
    def __init__(self):
        ...
        self.lives_x_start_pos = screen_width - (self.live_surf.get_size()[0] * 2 + 20)
        self.score = 0
        ...
        self.obstacles_x_positions = [
            num * (screen_width / self.obstacles_amount) for num in range(self.obstacles_amount)
        ]
